...
wr({ match = { class = "^(xdg-desktop-portal-gtk|xdg-desktop-portal-kde|xdg-desktop-portal-hyprland)(.*)$" }, float = true })
...
wr({ match = { class = "^(Spotify)$" }, opacity = 0.7 })
wr({ match = { class = "^(nemo)$" }, opacity = 0.7 })
wr({ match = { class = "^(thunar)$" }, opacity = 0.7 })
wr({ match = { class = "^(discord)$" }, opacity = 0.85 })
wr({ match = { class = "^(org.telegram.desktop)$" }, opacity = 0.85 })
wr({ match = { class = "^(code)$" }, opacity = 0.9 })

-- General window rules
wr({ match = { class = "^(spotify)$" }, no_initial_focus = true, suppress_event = "activatefocus", workspace = "name:spotify" })
...
wr({ match = { class = "^(dota2|steam_app.*|gamescope)$" }, workspace = "name:game" })
wr({ match = { class = "^(steam)$", title = "^(Friends List)$" }, float = true })
wr({ match = { class = "^(steam)$" }, size = "100% 100%", workspace = "name:steam" })
...
wr({ match = { class = "^(org.telegram.desktop)$" }, workspace = "name:right", no_initial_focus = true })
wr({ match = { class = "^(FFPWA.*)$", title = "^(Messenger)$" }, workspace = "name:right", no_initial_focus = true })
wr({ match = { class = "^(discord)$" }, workspace = "name:right", no_initial_focus = true })
wr({ match = { class = "^(FFPWA.*)$", title = "^(.*Home Assistant.*)$" }, workspace = "name:left", no_initial_focus = true })
