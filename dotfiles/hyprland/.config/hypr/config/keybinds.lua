...
hl.bind("SUPER + A", dsp.focus({ workspace = "name:left" }), { description = "Switch to workspace left" })
hl.bind("SUPER + D", dsp.focus({ workspace = "name:right" }), { description = "Switch to workspace right" })
hl.bind("SUPER + S", dsp.focus({ workspace = "name:spotify" }), { description = "Switch to workspace spotify" })
hl.bind("SUPER + T", dsp.focus({ workspace = "name:steam" }), { description = "Switch to workspace steam" })
hl.bind("SUPER + G", dsp.focus({ workspace = "name:game" }), { description = "Switch to workspace game" })
